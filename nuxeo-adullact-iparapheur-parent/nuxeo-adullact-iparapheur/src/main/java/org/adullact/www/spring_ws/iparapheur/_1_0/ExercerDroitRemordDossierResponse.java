/**
 * ExercerDroitRemordDossierResponse.java
 *
...
public class ExercerDroitRemordDossierResponse  implements java.io.Serializable {
    private org.adullact.www.spring_ws.iparapheur._1_0.MessageRetour messageRetour;

    public ExercerDroitRemordDossierResponse() {
    }
    ...
    /**
     * Gets the messageRetour value for this ExercerDroitRemordDossierResponse.
     * 
    ...
    /**
     * Sets the messageRetour value for this ExercerDroitRemordDossierResponse.
     * 
     * @param messageRetour
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExercerDroitRemordDossierResponse)) return false;
        ExercerDroitRemordDossierResponse other = (ExercerDroitRemordDossierResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExercerDroitRemordDossierResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.adullact.org/spring-ws/iparapheur/1.0", ">ExercerDroitRemordDossierResponse"));
