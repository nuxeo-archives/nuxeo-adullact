/**
 * EffacerDossierRejeteResponse.java
 *
...
public class EffacerDossierRejeteResponse  implements java.io.Serializable {
    private org.adullact.www.spring_ws.iparapheur._1_0.MessageRetour messageRetour;

    public EffacerDossierRejeteResponse() {
    }
    ...
    /**
     * Gets the messageRetour value for this EffacerDossierRejeteResponse.
     * 
    ...
    /**
     * Sets the messageRetour value for this EffacerDossierRejeteResponse.
     * 
     * @param messageRetour
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EffacerDossierRejeteResponse)) return false;
        EffacerDossierRejeteResponse other = (EffacerDossierRejeteResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EffacerDossierRejeteResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.adullact.org/spring-ws/iparapheur/1.0", ">EffacerDossierRejeteResponse"));
